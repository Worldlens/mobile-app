...
class _CameraViewState extends State<CameraView> {
  ...
  Widget _liveFeedBody() {
    if (_cameras.isEmpty) return const InitCameraView();
    if (_controller == null) return const InitCameraView();
    if (_controller?.value.isInitialized == false) return const InitCameraView();
    return Container(
      color: Colors.black,
      child: Stack(
        fit: StackFit.expand,
